      ...
      if referral
        if referral.ad_id
          ...
          if referral.ref.start_with?("referral")
            ...
            Sweep::User.create(facebook_uuid: user.id, onboard: true, referral_code: referral_code, source: "referred")
            ...
            Sweep::User.create(facebook_uuid: user.id, onboard: true, team: team, source: source)
            ...
            if ref.nil?
              ...
              Sweep::User.create(facebook_uuid: user.id, onboard: true, team: ref, source: "social_media")
