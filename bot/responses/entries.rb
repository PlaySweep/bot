...
def general_entry_info
  message.typing_on
  sweepy = Sweep::User.find(facebook_uuid: user.id)
  quick_replies = quick_replies = [{content_type: :text, title: "Play again", payload: "PLAY"}, {content_type: :text, title: "Status", payload: "STATUS"}]
...
def entry_status
  message.typing_on
  sweepy = Sweep::User.find(facebook_uuid: user.id)
  quick_replies = quick_replies = [{content_type: :text, title: "Play again", payload: "PLAY"}, {content_type: :text, title: "Status", payload: "STATUS"}, {content_type: :text, title: "Share", payload: "SHARE"}]
