...
def current_prizing_info
  ...
  say "We have 2 Browns Tickets up for grabs for the upcoming #{sweepy.roles.first.abbreviation} contest! Invite your friends to boost your entries and increase your chances at taking the prize!", quick_replies: quick_replies
  stop_thread
  message.typing_off
end
