module Commands
  def handle_my_picks
    ...
    #     stop_thread and return show_media_with_button(user.id, 'dashboard', DASHBOARD_IMAGE)
    #   rescue Exception => e
    ...
    #     short_wait(:message)
    #     stop_thread and return show_media_with_button(user.id, 'dashboard', @api.user.images.for_status) # || hard_coded_image)
